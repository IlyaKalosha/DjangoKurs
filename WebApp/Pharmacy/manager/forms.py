...
class AddSeller(forms.Form):
    ...
    password = forms.CharField(max_length=50, label="",
                           widget=forms.PasswordInput(
                               attrs={'class': 'form-control my-1', 'autocomplete': 'off', 'placeholder': 'Пароль'}))
...
class PillSearchCost(forms.Form):
    startcost = forms.IntegerField(label="",
                            widget=forms.NumberInput(
                                attrs={'class': 'form-control my-1', 'placeholder': 'Начальная цена'}))
    endcost = forms.IntegerField(label="",
                                   widget=forms.NumberInput(
...
class AddPill(forms.Form):
    ...
    regdate = forms.DateField(label="", input_formats=['%d/%m/%Y %H:%M'],
                              widget=forms.DateTimeInput(
    ...
    enddate = forms.DateField(label="", input_formats=['%d/%m/%Y %H:%M'], required=None,
                              widget=forms.DateTimeInput(
...
class UpdatePill(forms.Form):
    ...
    regdate = forms.DateField(label="", input_formats=['%d/%m/%Y %H:%M'], required=None,
                              widget=forms.DateTimeInput(
